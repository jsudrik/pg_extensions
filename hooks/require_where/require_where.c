 ...
 *
 * source: 
 *        https://www.youtube.com/watch?v=o0hMam1hsJE
 *
 * IDENTIFICATION
 ...
 */
static void
require_where_hook(ParseState *pstate, Query *query, JumbleState *jstate)
{
...
_PG_init(void)
{
    ...
    post_parse_analyze_hook = require_where_hook;
}
